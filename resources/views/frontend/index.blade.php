            ...
            <div class="col-lg-12">
                <div class="main-banner-wrapper">
                    <div class="banner-style-one owl-theme owl-carousel">
                        <div class="slide slide-one sh2" style="background-image: url({{ asset('frontend/images/home/4.jpg') }});">
                            {{-- <div class="container">
                                <div class="row">
                        ...
                        <div class="slide slide-one sh2" style="background-image: url({{ asset('frontend/images/home/5.jpg') }});">
                            {{-- <div class="container">
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                        ...
                        <div class="slide slide-one sh2" style="background-image: url({{ asset('frontend/images/home/6.jpg') }});">
                            {{-- <div class="container">
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                                        <h3 class="banner-title">Start Investing in You</h3>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="top_courses">
                    <div class="thumb">
                        <img class="img-whp" src="{{asset('frontend/images/courses/t2.jpg') }}" alt="t2.jpg">
                        <div class="overlay">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="top_courses">
                    <div class="thumb">
                        <img class="img-whp" src="{{asset('frontend/images/courses/t3.jpg') }}" alt="t3.jpg">
                        <div class="overlay">
                            <div class="tag">Top Seller</div>
                            <div class="icon"><span class="flaticon-like"></span></div>
                            <a class="tc_preview_course" href="#">Preview Course</a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="top_courses">
                    <div class="thumb">
                        <img class="img-whp" src="{{asset('frontend/images/courses/t4.jpg') }}" alt="t4.jpg">
                        <div class="overlay">
                            <div class="tag">Best Seller</div>
                            <div class="icon"><span class="flaticon-like"></span></div>
                            <a class="tc_preview_course" href="#">Preview Course</a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="top_courses">
                    <div class="thumb">
                        <img class="img-whp" src="{{asset('frontend/images/courses/t5.jpg') }}" alt="t5.jpg">
                        <div class="overlay">
                            <div class="tag">Best Seller</div>
                            <div class="icon"><span class="flaticon-like"></span></div>
                            <a class="tc_preview_course" href="#">Preview Course</a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="top_courses">
                    <div class="thumb">
                        <img class="img-whp" src="{{asset('frontend/images/courses/t6.jpg') }}" alt="t6.jpg">
                        <div class="overlay">
                            <div class="tag">Top Seller</div>
                            <div class="icon"><span class="flaticon-like"></span></div>
                            <a class="tc_preview_course" href="#">Preview Course</a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="top_courses">
                    <div class="thumb">
                        <img class="img-whp" src="{{asset('frontend/images/courses/t7.jpg') }}" alt="t7.jpg">
                        <div class="overlay">
                            <div class="tag">Top Seller</div>
                            <div class="icon"><span class="flaticon-like"></span></div>
                            <a class="tc_preview_course" href="#">Preview Course</a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="top_courses">
                    <div class="thumb">
                        <img class="img-whp" src="{{asset('frontend/images/courses/t8.jpg') }}" alt="t8.jpg">
                        <div class="overlay">
                            <div class="tag">Best Seller</div>
                            <div class="icon"><span class="flaticon-like"></span></div>
                            <a class="tc_preview_course" href="#">Preview Course</a>
            ...
            <div class="col-lg-6 offset-lg-3">
                <div class="courses_all_btn text-center">
                    <a class="btn btn-transparent" href="#">Hiển Thị Toàn Bộ Khóa Học</a>
                </div>
            </div>
        </div>
    </div>
