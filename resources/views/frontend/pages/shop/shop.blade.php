            ...
            <div class="col-xl-6 offset-xl-3 text-center">
                <div class="breadcrumb_content">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('shop') }}">Cửa hàng</a></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="instructor_search_result style2">
                            ...
                            <p class="mt10 fz15"><span class="color-dark pr10">Hiển thị 1 - 2</span>trên <span class="color-dark pr10">5 sản phẩm</span></p>
                        </div>
                    </div>
                    <div class="col-xl-8">
