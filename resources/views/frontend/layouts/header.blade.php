    ...
    <div class="container">
        ...
        <nav>
            ...
            <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                ...
                <li>
                    <a href=""><span class="title">Về Chúng Tôi</span></a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('shop') }}"><span class="title">Cửa Hàng</span></a>
                </li>
                <li class="last">
                            ...
                            <li>
                                ...
                                <ul class="dropdown_content">
                                    <li class="list_content">
                                        <a href="#">
                                            <img class="float-left" src="{{ asset('frontend/images/50x50.png') }}"
                                                alt="50x50">
                                            <p>Dolar Sit Amet</p>
                                            <small>1 × $7.90</small>
...
<div id="page" class="stylehome1 home2 h0">
    ...
    <nav id="menu" class="stylehome1">
        <ul>
            ...
            <li><a href=""><span class="title">Khóa Học</span></a></li>
            <li><a href=""><span class="title">Cửa Hàng</span></a></li>
            <li><a href=""><span class="title">Tin Tức</span></a></li>
            <li><a href=""><span class="title">Liên Hệ</span></a></li>
            {{-- <li><span>Pages</span>
                <ul>
