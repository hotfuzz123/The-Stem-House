...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="{{ URL::to('/admin/dashboard') }}">Trang
                    chủ</a>&nbsp;<i class="fa fa-angle-right"></i>
            </li>
                    ...
                    <div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd"
                        ...
                        <ul class="media-list list-items">
                            <li class="media"><img class="media-object"
                                    src="{{ asset('public/backend/admin/img/prof/prof3.jpg') }}" width="35"
                                    height="35" alt="...">
                            ...
                            <li class="media">
                                <div class="media-status">
                                    ...
                                    src="{{ asset('public/backend/admin/img/prof/prof1.jpg') }}" width="35"
                                    height="35" alt="...">
                                <i class="busy dot"></i>
                                <div class="media-body">
                            ...
                            <li class="media"><img class="media-object"
                                    src="{{ asset('public/backend/admin/img/prof/prof5.jpg') }}" width="35"
                                    height="35" alt="...">
                                <i class="away dot"></i>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="media-status">
                                    ...
                                    src="{{ asset('public/backend/admin/img/prof/prof4.jpg') }}" width="35"
                                    height="35" alt="...">
                                <i class="online dot"></i>
                                <div class="media-body">
                            ...
                            <li class="media"><img class="media-object"
                                    src="{{ asset('public/backend/admin/img/prof/prof2.jpg') }}" width="35"
                                    height="35" alt="...">
                                <i class="busy dot"></i>
                                <div class="media-body">
                            ...
                            <li class="media"><img class="media-object"
                                    src="{{ asset('public/backend/admin/img/prof/prof7.jpg') }}" width="35"
                                    height="35" alt="...">
                                <i class="online dot"></i>
                                <div class="media-body">
                        ...
                        <ul class="media-list list-items">
                            <li class="media">
                                <div class="media-status">
                                    ...
                                    src="{{ asset('public/backend/admin/img/prof/prof6.jpg') }}" width="35"
                                    height="35" alt="...">
                            ...
                            <li class="media"><img class="media-object"
                                    src="{{ asset('public/backend/admin/img/prof/prof8.jpg') }}" width="35"
                                    height="35" alt="...">
                                <i class="offline dot"></i>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="media-status">
                                    ...
                                    src="{{ asset('public/backend/admin/img/prof/prof9.jpg') }}" width="35"
                                    height="35" alt="...">
                                <i class="offline dot"></i>
                                <div class="media-body">
                            ...
                            <li class="media"><img class="media-object"
                                    src="{{ asset('public/backend/admin/img/prof/prof10.jpg') }}" width="35"
                                    height="35" alt="...">
                                <i class="offline dot"></i>
                                <div class="media-body">
