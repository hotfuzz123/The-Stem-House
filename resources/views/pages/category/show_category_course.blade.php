                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="instructor_search_result style2">
                            <p class="mt10 fz15"><span class="color-dark pr10">Hiển thị {{ $category_by_id->firstItem() }} - {{ $category_by_id->lastItem() }}</span>trên <span class="color-dark pr10">{{ $category_by_id->total() }} khóa học</span></p>
                        </div>
                    </div>
                    <div class="col-xl-8">
