    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-topline-red">
                <div class="card-head">
                    <header>Bảng danh sách khóa học</header>
                    <div class="tools">
                        ...
                        <div class="col-md-6 col-sm-6 col-6">
                            <div class="btn-group">
                                <button id="addRow1" class="btn btn-info">
                                    <a style="color:white; font-weight:700;" href="{{URL::to('/add-course') }}">Thêm khóa học <i class="fa fa-plus"></i></a>
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example4" rowspan="1"
                                                    ...
                                                    style="width: 225px;"> Tên khóa học </th>
                                                <th class="sorting" tabindex="0" aria-controls="example4" rowspan="1"
                                                    colspan="1" aria-label=" Status : activate to sort column ascending"
                                                    style="width: 176px;"> Giá </th>
                                                <th class="sorting" tabindex="0" aria-controls="example4" rowspan="1"
                                                    colspan="1" aria-label=" Username : activate to sort column ascending"
                                                    style="width: 225px;"> Ảnh bìa khóa học </th>
                                                    <th class="sorting" tabindex="0" aria-controls="example4" rowspan="1"
                                                    colspan="1" aria-label=" Status : activate to sort column ascending"
                                            ...
                                            <tr class="gradeX odd" role="row">
                                                ...
                                                <td>
                                                    <span class="">
                                                        ...
                                                        ?>
                                                        <a href="{{URL::to('/active-course/' .$pro->course_id)}}"><span class="label label-sm label-danger">Ẩn</span></a>
                                                        <?php
                                                        }
                                                        ?>
                                                    </span>
                                                ...
                                                <td class="valigntop">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            ...
                                                            <li>
                                                                <a onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này không?')" href="{{URL::to('/delete-course/' .$pro->course_id)}}">
