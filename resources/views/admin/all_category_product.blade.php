                                            ...
                                            <tr class="gradeX odd" role="row">
                                                ...
                                                <td>
                                                    <span class="">
                                                        ...
                                                        ?>
                                                        <a href="{{URL::to('/unactive-category-product/' .$cate_pro->category_id)}}"><span class="label label-sm label-danger">Ẩn</span></a>
                                                        <?php
                                                        }else {
                                                        ?>
                                                        <a href="{{URL::to('/active-category-product/' .$cate_pro->category_id)}}"><span class="label label-sm label-success"> Hiển thị </span></a>
                                                        <?php
                                                        }
                                                        ?>
                                                    </span>
