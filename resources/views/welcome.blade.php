...
<body>
            ...
            <div class="container">
                ...
                <nav>
                    ...
                    <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                        <li>
                            <a href="index2.html"><span class="title">Home</span></a>
                        </li>
                        <li>
                    ...
                    <div class="col-lg-12">
                        <div class="blog_post_slider_home2">
                            <div class="item">
                                <div class="blog_post_home2">
                                    <div class="bph2_header">
                                        <img class="img-fluid" src="{{ ('public/frontend/images/blog/4.jpg') }}" alt="4.jpg">
                                        ...
                                        <div class="post_meta">
                                            <ul>
                                                <li class="list-inline-item"><a href="#"><i
                                                            class="flaticon-calendar"></i> 8:00 am - 5:00 pm</a></li>
                                                <li class="list-inline-item"><a href="#"><i
                            ...
                            <div class="item">
                                <div class="blog_post_home2">
                                    <div class="bph2_header">
                                        <img class="img-fluid" src="{{ ('public/frontend/images/blog/5.jpg') }}" alt="5.jpg">
                                        <a href="#" class="bph2_date_meta">
                                            <span class="year">28 <br> March</span>
                                        </a>
                                    </div>
                        ...
                        <div class="testimonial_slider_home2">
                            <div class="item">
                                <div class="testimonial_item home2">
                                    <div class="details">
                                        ...
                                        <p>It was really fun getting to know the team during the project. They were all
                                            helpful in answering my questions and made me feel completely at ease.The
                                            design ended up being twice as good as I could have ever envisioned!</p>
                                    </div>
                                    <div class="thumb">
                                        <img class="img-fluid rounded-circle" src="{{ ('public/frontend/images/testimonial/1.jpg') }}"
                                            alt="1.jpg">
                            ...
                            <div class="item">
                                <div class="testimonial_item home2">
                                    ...
                                    <div class="thumb">
                                        <img class="img-fluid rounded-circle" src="{{ ('public/frontend/images/testimonial/2.jpg') }}"
                                            alt="2.jpg">
                            ...
                            <div class="item">
                                <div class="testimonial_item home2">
                                    ...
                                    <div class="thumb">
                                        <img class="img-fluid rounded-circle" src="{{ ('public/frontend/images/testimonial/3.jpg') }}"
                                            alt="3.jpg">
                    ...
                    <div class="col-sm-6 col-lg-6 col-xl-6">
                        <div class="becomea_instructor tac-xxsd">
                            <div class="bi_grid">
                                ...
                                <p>Teach what you love. Dove Schooll gives you the tools to create an <br class="dn-lg">
                                    online course.</p>
                                <a class="btn btn-thm" href="#">Start Teaching <span
                    ...
                    <div class="col-sm-6 col-lg-6 col-xl-6">
                        <div class="becomea_instructor style2 text-right tac-xxsd">
                            <div class="bi_grid">
                                ...
                                <p>Get unlimited access to 2,500 of Udemy’s top courses for <br class="dn-lg"> your
                                    team.</p>
                                <a class="btn btn-dark" href="#">Doing Business <span
                                        class="flaticon-right-arrow-1"></span></a>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Wrapper End -->
    <script type="text/javascript" src="{{('public/frontend/js/jquery-3.3.1.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/jquery-migrate-3.0.0.min.js')}}"></script>
    ...
    <script type="text/javascript" src="{{('public/frontend/js/jquery.mmenu.all.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/ace-responsive-menu.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/bootstrap-select.min.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/snackbar.min.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/simplebar.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/parallax.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/scrollto.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/jquery-scrolltofixed-min.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/jquery.counterup.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/wow.min.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/progressbar.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/slider.js')}}"></script>
    <script type="text/javascript" src="{{('public/frontend/js/timepicker.js')}}"></script>
